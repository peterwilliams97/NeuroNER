...
class EntityLSTM(object):
    ...
    def __init__(self, dataset, parameters):
        ...
        if parameters['use_character_lstm']:
            ...
            # Idea: reshape so that we have a tensor
            # [number_of_token, max_token_length, token_embeddings_size], which we pass to the LSTM
        ...
        if parameters['use_crf']:
            with tf.variable_scope("crf") as vs:
                ...
                # Compute the log-likelihood of the gold sequences and keep the transition params for inference at test
                # time.
    ...
    def define_training_procedure(self, parameters):
        ...
        # By defining a global_step variable and passing it to the optimizer we allow TensorFlow handle the counting of
        # training steps for us.
